...
```javascript
nanmin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanmin@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-nanmin/tags). For example,

```javascript
nanmin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanmin@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var nanmin = require( 'path/to/vendor/umd/stats-strided-nanmin/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-nanmin@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-nanmin.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-nanmin

[test-image]: https://github.com/stdlib-js/stats-strided-nanmin/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-nanmin/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-nanmin/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-nanmin?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-nanmin.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-nanmin/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-nanmin/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-nanmin/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-nanmin/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-nanmin/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-nanmin/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-nanmin/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-nanmin/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-nanmin/main/LICENSE
